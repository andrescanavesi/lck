...
function convertRow(row) {
  return {
    ...
    active: row.active,
    related_recipes_ids_csv: row.related_recipes_ids_csv,
    url: `${process.env.LCK_BASE_URL}/l/${row.term_seo}`,
    featured_image_url: `${process.env.LCK_DEFAULT_IMAGE_URL}`,
    thumbnail_image_url: `${process.env.LCK_DEFAULT_IMAGE_URL}`,
  };
}
